...
--------------------
Load results produced by `classifier_comparison.py` and produce simple
matplotlib visualizations for key metrics and training times. Also prints a
concise textual summary to the console.
"""
...
# Create a 2x2 grid of metric plots
...
# Training time comparison (flattened bars)
...
# Print a concise textual summary for quick inspection
